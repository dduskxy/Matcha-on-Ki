  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 h-[85vh] flex flex-col justify-between items-center text-center relative z-10 pt-10 pb-4">
        ...
        >
          <span className="font-sans text-[10px] md:text-xs tracking-[0.5em] uppercase text-luxury-matcha font-medium mb-8 block">The Art of Stillness</span>
          
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif leading-[1.1] tracking-wide relative flex flex-col items-center">
            <span className="overflow-hidden block pb-2 text-luxury-charcoal">
              <motion.span 
            ...
            <span className="overflow-hidden block pb-2 text-luxury-charcoal/70 italic">
              <motion.span 
                initial={{ y: "110%", rotate: 2, opacity: 0 }}
                animate={{ y: 0, rotate: 0, opacity: 1 }}
        ...
        >
          <p className="max-w-xl mx-auto text-sm md:text-base text-luxury-charcoal/80 font-light leading-loose mb-10 relative">
            <span className="absolute -left-6 top-3 w-4 h-[1px] bg-luxury-matcha/30 hidden md:block"></span>
            <span className="absolute -right-6 top-3 w-4 h-[1px] bg-luxury-matcha/30 hidden md:block"></span>
          ...
          <Magnetic strength={20}>
            <Link to="/menu" className="group inline-flex items-center gap-4 border-b border-luxury-charcoal/30 pb-2 hover:border-luxury-matcha transition-all duration-700 text-luxury-charcoal hover:text-luxury-matcha">
